...
export class AddIndex1704381565198 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`notes\` ADD \`content\` varchar(255) NOT NULL`);
        await queryRunner.query(`CREATE INDEX \`index_userId_content\` ON \`notes\` (\`content\`, \`user_id\`)`);
    }
