...
export class AddUserAndNotesEntities1704311611320
  implements MigrationInterface
{
  name = 'AddUserAndNotesEntities1704311611320';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`first_name\` text NOT NULL, \`last_name\` text NOT NULL, \`user_name\` varchar(200) NOT NULL, \`mail_id\` varchar(200) NOT NULL, \`crypted_password\` text NOT NULL, \`created_at\` datetime NOT NULL, \`updated_at\` datetime NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
